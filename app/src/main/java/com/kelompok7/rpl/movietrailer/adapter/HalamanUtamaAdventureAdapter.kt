...
class HalamanUtamaAdventureAdapter: RecyclerView.Adapter<HalamanUtamaAdventureAdapter.HalamanUtamaAdventureViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HalamanUtamaAdventureViewHolder {
        val itemCardHalamanUtamaBinding = ItemCardHalamanUtamaBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return HalamanUtamaAdventureViewHolder(itemCardHalamanUtamaBinding)
    }

    override fun onBindViewHolder(holder: HalamanUtamaAdventureViewHolder, position: Int) {
        holder.bind(dataMovie[position])
    }

    override fun getItemCount(): Int = 5

    class HalamanUtamaAdventureViewHolder(private val binding: ItemCardHalamanUtamaBinding): RecyclerView.ViewHolder(binding.root) {
